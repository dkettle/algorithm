 ...
 */
package com.baidu.algorithm.util;
...
public class Utils {
    ...
    private static TreeLinkNode buildTreeLinkNode(int v) {

        return v == -1 ? null : new TreeLinkNode(v);
    }

    public static TreeLinkNode buildLinkTree(int... num) {

        TreeLinkNode root = buildTreeLinkNode(num[0]);
        ...
        while (!queue.isEmpty() && i + 1 < num.length) {
            ...
            cur.left = buildTreeLinkNode(num[i]);
            cur.right = buildTreeLinkNode(num[i + 1]);
